...
@register_criterion("nat_loss_ngram_glat_asr", dataclass=LabelSmoothedDualImitationCriterionConfig)
class LabelSmoothedDualImitationCriterion(FairseqCriterion):
    def __init__(self, task, label_smoothing, glat_p):
        super().__init__(task)
    ...
    def forward(self, model, sample, reduce=True):
        ...
        tgt_tokens, prev_output_tokens = sample["transcript"], sample["prev_target"]
        transcript_tokens = sample["transcript"]
        ...
        outputs, glat_info = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens, transcript_tokens, glat)
        losses, nll_loss = [], []
