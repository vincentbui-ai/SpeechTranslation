...
class SpeechToTextModifiedTask(LegacyFairseqTask):
    @classmethod
    def add_args(cls, parser):
        ...
        #To be compatible with updated Transformer
        '''
        parser.add_argument(
    ...
    def max_positions(self):
        return getattr(self.args, "max_source_positions", DEFAULT_MAX_AUDIO_POSITIONS), getattr(self.args, "max_target_positions", DEFAULT_MAX_TEXT_POSITIONS)
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        return super(SpeechToTextModifiedTask, self).build_model(args, from_checkpoint)
